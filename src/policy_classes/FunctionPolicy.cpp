...
namespace srcDispatch {
    std::string FunctionData::ToString(srcDispatch::DiffOperation operation) const {
    ...
    FunctionPolicy::FunctionPolicy(std::initializer_list<srcDispatch::PolicyListener *> listeners)
    ...
    std::any FunctionPolicy::DataInner() const { return std::make_shared<FunctionData>(data); }

    void FunctionPolicy::Notify(const PolicyDispatcher* policy, const srcDispatch::srcSAXEventContext& ctx) {
    ...
    void FunctionPolicy::NotifyWrite(const PolicyDispatcher* policy [[maybe_unused]], srcDispatch::srcSAXEventContext& ctx [[maybe_unused]]) {}

    void FunctionPolicy::InitializeFunctionPolicyHandlers() {
    ...
    void FunctionPolicy::CollectXMLAttributeHandlers() {}

    void FunctionPolicy::CollectGenericHandlers() {
        using namespace srcDispatch;
    ...
    void FunctionPolicy::CollectTypeHandlers() {
        using namespace srcDispatch;
    ...
    void FunctionPolicy::CollectNameHandlers() {
        using namespace srcDispatch;
    ...
    void FunctionPolicy::CollectParameterHandlers() {
        using namespace srcDispatch;
    ...
    void FunctionPolicy::CollectCallHandlers() {
        using namespace srcDispatch;
    ...
    void FunctionPolicy::CollectOtherHandlers() {
        using namespace srcDispatch;
    ...
    void FunctionPolicy::CollectBlockHandlers() {
        using namespace srcDispatch;
